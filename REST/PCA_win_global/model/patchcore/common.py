...
class NearestNeighbourScorer_gpu(object):
    ...
    def predict(
        self, ref_features, ref_pca_features,query_features,query_pca_features,nn_num,p,method='square'
    ):
        ...
        _,query_nns =  torch.topk(torch.cdist(query_pca_features,ref_pca_features,p=2),nn_num,1,largest=False)
        ...
        residuals = ref_features[query_single_nns] - query_features
