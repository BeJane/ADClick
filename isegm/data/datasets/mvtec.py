...
class MvtecDataset(ISDataset):
    ...
    def get_sample(self, index) -> DSample:
        ...
        # plt.show()
        if 'test' in self.dataset_split:
            return DSample(image, instances_mask,residual, objects_ids=[1], sample_id=index),sample_id
        return DSample(image, instances_mask, residual,objects_ids=[1],sample_id=index)
