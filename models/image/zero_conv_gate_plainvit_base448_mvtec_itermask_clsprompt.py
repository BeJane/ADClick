...
MODEL_NAME = 'mvtec_zero_conv_gate_clsprompt_plainvit'
...
def init_model(cfg):
    ...
    ckpt = load_torch_checkpoint(f"model_posfar/no_ok/mvtec_clsprompt/{cfg.category}/checkpoints/008.pth", map_location='cpu')
